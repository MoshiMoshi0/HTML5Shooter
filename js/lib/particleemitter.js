...
(function (scope) {
    ...
    s.DEFAULT_PARTICLE = new createjs.Shape(new createjs.Graphics().s("#ff9900").ss(12).mt(0,0).lt(6,0));
    ...
    var p = ParticleEmitter.prototype = {
        ...
        createParticle: function(position, props, particle) {
            ...
            if (emitAngle == 360) {
                ...
                angle = (Math.random() * spread*2 - spread + emitAngle) * Math.PI / 180;
            }
        ...
        tick: function() {
            for(var i = 0, l = this.particles.length; i < l; i++) {
                ...
                if (p.rotate) { s.rotation = Math.atan2(p.vy, p.vx) * 180 / Math.PI; }
